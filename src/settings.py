import os
JSON_RUL = os.environ.get(
    "JSON_URL", 'https://noricha-vr.github.io/toGithubPagesJson/sample.json')
JSON_IMAGE_KEY = os.environ.get("JSON_IMAGE_KEY", "ポスター")
BUKECT_NAME = os.environ.get("BUKECT_NAME", "ta-a-gathering")
GCS_FILE_PATH = os.environ.get("GCS_FILE_PATH", "poster.mp4")
